...
##### General Goal: 
Based on the shiny app, users can input the tweets they want to send or analysis. For different index, they will have different functions (it will be explained in Getting Started). In the Shiny App, user can choose what kind of sentiment chart they want to see and change different variable to see how to influence the sentiment.  
##### Getting Started: 
It is the GUI interface when user start the graph is here. 
![Implemtation of the search ](./zhangh20Folder/Implemented_UI.jpg)
